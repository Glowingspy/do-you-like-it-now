...
def main_code():
    ...
    while y != x:
        ...
        while len(system) != (7):
            ...
            break
        if len(system) == 7:
            print('STOP!! You have reached your maximum number of chances. The number was ' + str(x))
            time.sleep(0.5)
    ...
    if y == x :
        ...
        z = input()
        if z == 'no':
            print('Get out of here!!! But thank you for playing')
        elif z == 'yes':
            time.sleep(0.5)
            print('Ok')
            main_code()
